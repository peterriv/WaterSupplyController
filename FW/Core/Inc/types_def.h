...
typedef struct
{
	...
	// Общее кол-во воды, перекачанной насосом, литры
	uint32_t			WaterPumpedTotal;
	
	
	// Кол-во воды, перекачанной за текущие сутки, литры
	uint32_t			PumpedWaterQuantityToday;

	// Кол-во воды, перекачанной за вчерашние сутки, литры
	uint32_t			PumpedWaterQuantity1dayAgo;
	
	// Кол-во воды, перекачанной за позавчерашние сутки, литры
	uint32_t			PumpedWaterQuantity2daysAgo;

	// Кол-во воды, перекачанной в течение третьих суток назад, литры
	uint32_t			PumpedWaterQuantity3daysAgo;

	// Кол-во воды, перекачанной в течение четвёртых суток назад, литры
	uint32_t			PumpedWaterQuantity4daysAgo;

	// Кол-во воды, перекачанной в течение пятых суток назад, литры
	uint32_t			PumpedWaterQuantity5daysAgo;

	// Кол-во воды, перекачанной в течение шестых суток назад, литры
	uint32_t			PumpedWaterQuantity6daysAgo;

	// Кол-во воды, перекачанной в течение седьмых суток назад, литры
