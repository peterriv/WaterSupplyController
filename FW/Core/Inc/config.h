...
// Значение в секундах для определения задержки вкл насоса по давлению
#define	PUMP_ON_DELAY															60
// Значение в секундах для определения задержки выкл насоса по давлению
#define	PUMP_OFF_DELAY														4
...
#define	PWR_CTRL1_ON														HAL_GPIO_WritePin(PWR_CTRL1_GPIO_Port, PWR_CTRL1_Pin, GPIO_PIN_RESET)
#define	PWR_CTRL1_OFF														HAL_GPIO_WritePin(PWR_CTRL1_GPIO_Port, PWR_CTRL1_Pin, GPIO_PIN_SET)

#define	UV_STERILIZER_ON													HAL_GPIO_WritePin(UV_STERILIZER_GPIO_Port, UV_STERILIZER_Pin, GPIO_PIN_RESET)
#define	UV_STERILIZER_OFF													HAL_GPIO_WritePin(UV_STERILIZER_GPIO_Port, UV_STERILIZER_Pin, GPIO_PIN_SET)
