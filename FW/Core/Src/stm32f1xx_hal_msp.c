...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = USART2_TX_NEXTION_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(USART2_TX_NEXTION_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USART2_RX_NEXTION_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    HAL_GPIO_Init(USART2_RX_NEXTION_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART2_TX_NEXTION_Pin|USART2_RX_NEXTION_Pin);
